...
syn keyword dScopeDecl             protected export package private 
" vlad edit - made public a statement so it would show up better as an interface
syn keyword dStatement             debug return with public
...
syn region dImport start="import\_s" end=";" contains=dExternal,@dComment,dType
